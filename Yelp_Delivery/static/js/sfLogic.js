...
function createMap(restaurants) {
  ...
  function drawDots(){ 
    ...
    var yelpapi= d3.json("https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?term=delivery&location=San%20Francisco&limit=50&radius=20000") 
